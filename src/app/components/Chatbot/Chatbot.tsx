...
const Chatbot = () => {
  ...
  return (
    <div>
      ...
      {isChatOpen && (
       <div className="fixed  bottom-[90px] xs:bottom-[10px] lg:bottom-[90px] z-50 right-4 xs:right-32 lg:right-8 max-sm:w-80  max-sm:max-h-[calc(100vh-60px)] sm:max-h-[calc(100vh-80px)]  lg:max-h-[calc(100vh-120px)] h-96 bg-white border border-gray-300 rounded-lg shadow-lg flex flex-col overflow-hidden">
